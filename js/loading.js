...
$('body').addClass('modal-active');
  ...
  var _LoadingHtml = '<div id="loadingDiv" style="position: fixed;top: 0;left: 0;width: 100%;height: 100%;background:#FFFFFF;opacity:1.0;filter:alpha(opacity=80);z-index:10000;"><div class="spinner" style="position: top: 60px; margin:' + _LoadingTop + 'px auto ;   width: 12rem;height: 12rem;background-color: #67CF22;background: url(images/tsp-pro.gif) no-repeat;background-size: 100% 100%;"></div></div>';
//呈现loading效果  
